...
async function main() {
  ...
  await prisma.quote.upsert({
    ...
    create: {
      ...
      currencyCode: "USD",
      freightSell: "2400.00",
      originChargesSell: "300.00",
      destinationChargesSell: "250.00",
      additionalChargesSell: "100.00",
      totalSell: "3050.00",
      freightCost: "1800.00",
      originChargesCost: "250.00",
      destinationChargesCost: "200.00",
      additionalChargesCost: "100.00",
      totalCost: "2350.00",
      grossMarginAmount: "700.00",
      grossMarginPercent: "0.2295",
